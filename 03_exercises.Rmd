...
#The variables in both datasets do not match. Using the left join function allows me to merge variables shared by both datasets but for reasons such as differences in plots planted in and number of seeds planted not matching the harvest, there will be some mismatched data. 
```
